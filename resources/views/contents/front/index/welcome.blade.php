    ...
    <div class="container px-lg-5">
        <div class="row g-5 align-items-end">
            <div class="col-lg-6 text-center text-lg-start">
                <h1 class="text-white mb-4 animated slideInDown">The free, fun, and effective way to learn Programming languages!</h1>
                <p class="text-white pb-3 animated slideInDown">Learning with Learnify is fun, and research shows that it works! With quick, bite-sized lessons, you’ll earn points and unlock new levels while gaining real-world communication skills.</p>
    ...
    <div class="container py-5 px-lg-5">
        <div class="row g-5 align-items-center">
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                <p class="section-title text-secondary">learnify<span></span></p>
                <h1 class="mb-5">What's learnify</h1>
...
<div class="container-xxl py-5">
    <div class="container py-5 px-lg-5">
        <div class="wow fadeInUp" data-wow-delay="0.1s">
            <p class="section-title text-secondary justify-content-center"><span></span>Why Learnify<span></span></p>
            <h1 class="text-center mb-5">Why you’ll love learning with Learnify</h1>
        </div>
        <div class="row g-4">
    ...
    <div class="container py-5 px-lg-5">
        <div class="row justify-content-center">
            <div class="col-lg-7 text-center">
                ...
                <p class="text-white mb-4">Keep Up With The Latest Learn new skills and insights from our experts and instructors. Join our newsletter and get access to exclusive content and offers. Whether you want to improve your career or your hobby, we have something for you. Subscribe now and never miss an opportunity to grow.</p>
    ...
    <div class="container py-5 px-lg-5">
        ...
        <div class="row g-4">
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="team-item bg-light rounded">
                    <div class="text-center border-bottom p-4">
                        <img class="img-fluid rounded-circle mb-4" src="front/img/team-1.png" alt="">
                        <h5>Wildan Frananda</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="team-item bg-light rounded">
                    <div class="text-center border-bottom p-4">
                        <img class="img-fluid rounded-circle mb-4" src="front/img/team-2.png" alt="">
                        <h5>Nenden Nur Himami</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item bg-light rounded">
                    <div class="text-center border-bottom p-4">
                        <img class="img-fluid rounded-circle mb-4" src="front/img/team-3.png" alt="">
                        <h5>Abdul Malik Dzakwan</h5>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="team-item bg-light rounded">
                    <div class="text-center border-bottom p-4">
                        <img class="img-fluid rounded-circle mb-4" src="front/img/team-4.png" alt="Bussines Analyst">
                        <h5>Afifah Pertiwi</h5>
                        <span>Bussines Analyst</span>
                    </div>
                    <div class="d-flex justify-content-center p-4">
                        <a class="btn btn-square mx-1" href=""><i class="fab fa-facebook-f"></i></a>
                        <a class="btn btn-square mx-1" href=""><i class="fab fa-twitter"></i></a>
